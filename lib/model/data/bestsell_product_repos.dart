...
class BestSellProductRepos {
  Future<List<BestSellingProductModel>?> getProducts() async {
    try {
      const endPoint = "/bestsellingproducts";
      ...
      if (response.statusCode == AppConstants.api_success_StatusCode) {
        ...
        return bestSellingProductModelFromJson(response.body);
      }
      return null;
    } catch (e) {
