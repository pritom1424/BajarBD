...
List<HomeLatestProduct> homeLatestProductFromJson(String str) =>
    List<HomeLatestProduct>.from(
        json.decode(str).map((x) => HomeLatestProduct.fromJson(x)));

String homeLatestProductToJson(List<HomeLatestProduct> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class HomeLatestProduct {
  int id;
  String? title;
  String? description;
  ...
  factory HomeLatestProduct.fromJson(Map<String, dynamic> json) =>
      HomeLatestProduct(
        id: json["id"],
        title: json["title"],
