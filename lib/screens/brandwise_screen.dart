import 'package:bajarbd/widgets/brand/brandwise_grids.dart';
...
class BrandWiseScreen extends StatefulWidget {
  final String? title;
  final int brandID;
  const BrandWiseScreen({super.key, this.title, required this.brandID});

  @override
  State<BrandWiseScreen> createState() => _CatWiseScreenState();
}

class _CatWiseScreenState extends State<BrandWiseScreen> {
          ...
          children: [
            ...
            Consumer(builder: (ctx, ref, _) {
              return FutureBuilder(
                  future: ref
                      .watch(bandPageProvider)
                      .getBrandWiseProducts(widget.brandID),
